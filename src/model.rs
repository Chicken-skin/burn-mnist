...
use burn::{
    module::Module,
    nn::{
        self, loss::CrossEntropyLossConfig, BatchNorm, Dropout, DropoutConfig, Linear,
...
impl<B: Backend> Model<B> {
    pub fn new(device: &B::Device) -> Self {
        ...
        let conv2 = ConvBlock::new([8, 16], [3, 3], device); // out: [Batch, 16, 24, 24]
        let conv3 = ConvBlock::new([16, 24], [3, 3], device); // out: [Batch, 24, 22, 22]
...
/// Train step (forward and backward)
